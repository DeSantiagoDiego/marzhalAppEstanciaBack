...
router.get('/', function(req, res) {
    ...
    //res.end("<body style='background: black;'><div ><img src='/D3.svg'  alt='' style='padding-top: 15%; padding-bottom: 2%; display: block; margin-left: auto; margin-right: auto;'><img src='/marzhalId2.svg' alt='' style='padding-bottom: 5%; display: block; margin-left: auto; margin-right: auto;'><h1 style='color: white; text-align: center;'>Email " + "santiago__diego@hotmail.com" + " ha sido activado exitosamente.<br></h1><h1 style='color: #d2732b;text-align: center';>Por su seguridad, elimine el correo recibido una vez utilizado este link.</h1></div><h6 style='color: whitesmoke; font-size: 68%;text-align: center;padding-top: 3%;'>CYBERSECURITY EXPERTS</h6></body>");
    res.end("<body style='background: black;'><div ><img src='/D3.svg'  alt='' style='padding-top: 15%; padding-bottom: 2%; display: block; margin-left: auto; margin-right: auto;'><img src='/marzhalId2.svg' alt='' style='padding-bottom: 5%; display: block; margin-left: auto; margin-right: auto;'><h1 style='color: white; text-align: center;'>Autorizaci&oacute;n de cambio de contrase&ntilde;a para " + "santiago__diego@hotmail.com" + " aprobada. <br></h1><h1 style='color: #d2732b;text-align: center';>Por su seguridad, elimine el correo recibido una vez utilizado este link.</h1></div><h6 style='color: whitesmoke; font-size: 68%;text-align: center;padding-top: 3%;'>CYBERSECURITY EXPERTS</h6></body>");
});
...
router.get('/verify', async(req, res) => {
    ...
    if ((req.protocol + "://" + req.get('host')) == ("http://" + host)) {
        ...
        if (!user) {
            ...
            res.end("<body style='background: black;'><div ><img src='/D3.svg'  alt='' style='padding-top: 15%; padding-bottom: 2%; display: block; margin-left: auto; margin-right: auto;'><img src='/marzhalId2.svg' alt='' style='padding-bottom: 5%; display: block; margin-left: auto; margin-right: auto;'><h1 style='color: white; text-align: center;'>Email " + user.email + " ha sido activado exitosamente.<br></h1><h1 style='color: #d2732b;text-align: center';>Por su seguridad, elimine el correo recibido una vez utilizado este link.</h1></div><h6 style='color: whitesmoke; font-size: 68%;text-align: center;padding-top: 3%;'>CYBERSECURITY EXPERTS</h6></body>");
        }
        /*
...
router.get('/changePassword', async(req, res) => {
    ...
    if ((req.protocol + "://" + req.get('host')) == ("http://" + host)) {
        ...
        if (!user) {
            ...
            res.end("<body style='background: black;'><div ><img src='/D3.svg'  alt='' style='padding-top: 15%; padding-bottom: 2%; display: block; margin-left: auto; margin-right: auto;'><img src='/marzhalId2.svg' alt='' style='padding-bottom: 5%; display: block; margin-left: auto; margin-right: auto;'><h1 style='color: white; text-align: center;'>Autorizaci&oacute;n de cambio de contrase&ntilde;a para " + user.email + " aprobada. <br></h1><h1 style='color: #d2732b;text-align: center';>Por su seguridad, elimine el correo recibido una vez utilizado este link.</h1></div><h6 style='color: whitesmoke; font-size: 68%;text-align: center;padding-top: 3%;'>CYBERSECURITY EXPERTS</h6></body>");
        }
        /*//Espa&ntilde;a  contrase&ntilde;a
        if (req.query.id == rand) {
            console.log(req.query.id);
            console.log("Contrasena renovada");
